...
export default function DatePickerWithFullWidthButtons() {
  ...
  return (<>
    ...
    <section className="container-calendario">
        <div className="registra-cita ">
      <grid> Nombre <input placeholder="nombre"></input></grid>
      <grid> Fecha <input placeholder="Fecha"></input></grid>
      <grid> telefono <input placeholder="telefono"></input></grid>
      <button>Registrar</button></div>
      <div className="container p-3 m-3 justify-center">
        <div className="mx-auto p-3 w-full m-3 max-w-[510px]">
          <div className="relative m-3">
            <input
              id="datepicker"
              type="text"
              placeholder="Pick a date"
              className="h-120 w-full appearance-none rounded-lg border border-stroke bg-white p-3 m-3 justify-center text-dark outline-none focus:border-primary dark:border-dark-3 dark:bg-dark-2 dark:text-white"
              value={selectedDate || ""}
              readOnly
